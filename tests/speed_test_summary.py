...
SUMMARY_SPEED_RESULTS_PATH = os.path.join(REPORTS_DIR, "parsing_summary_speed_results.txt")
MEMORY_RESULTS_PATH = os.path.join(REPORTS_DIR, "parsing_summary_memory_results.log")

fp = open(MEMORY_RESULTS_PATH, "w+")

summary_parser = LocalSummaryParser(DATA_DIR)
...
if __name__ == "__main__":
    speed_test(
        main_function=summary_parser.parse_summary,
        files_list=summary_parser.list_summary_keys(),
