...
HISTORY_SPEED_RESULTS_PATH = os.path.join(REPORTS_DIR, "parsing_history_speed_results.txt")
MEMORY_RESULTS_PATH = os.path.join(REPORTS_DIR, "parsing_history_memory_results.log")

fp = open(MEMORY_RESULTS_PATH, "w+")

history_parser = LocalHandHistoryParser(DATA_DIR)
...
if __name__ == "__main__":
    speed_test(
        main_function=history_parser.parse_hand_history,
        files_list=history_parser.list_split_histories_keys(),
