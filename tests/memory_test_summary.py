...
SPEED_RESULTS_PATH = os.path.join(REPORTS_DIR, "parsing_summary_speed_results.csv")
FINANCIAL_COST_PATH = os.path.join(REPORTS_DIR, "parsing_summary_financial_cost.csv")
